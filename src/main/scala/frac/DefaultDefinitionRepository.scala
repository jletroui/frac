...
object DefaultDefinitionRepository extends DefinitionRepository with Using
{
  private[this] val path = Paths.get(Thread.currentThread.getContextClassLoader.getResource("definitions.frac"))
